    ...
    <div class="card-body row g-3 form-group">
        <form action="{{ route('customer.store') }}" method="POST">
            ...
            <div class="input-group mb-3">
                ...
                <input class="form-control" type="text" name="in_name" placeholder="Nama Pemesan" value="{{ old('in_name') }}" />
            </div>
            <div class="input-group mb-3">
                <span class="input-group-text">Alamat<span class="text-danger">*</span></span>
                <input class="form-control" type="text" name="in_address" placeholder="Alamat Pengiriman Pemesan" value="{{ old('in_address') }}" />
            </div>
            <div class="input-group mb-3">
                <span class="input-group-text">Kontak<span class="text-danger">*</span></span>
                <input class="form-control" type="text" name="in_phone" placeholder="No Telepon" value="{{ old('in_phone') }}" />
            </div>
